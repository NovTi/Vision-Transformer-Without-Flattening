...
class SAHead3(nn.Module):
    def __init__(self, in_channels, fp_num):
        ...
        # set the key kernels
        self.k_conv1 = nn.Conv2d(in_channels, in_channels, kernel_size=8, stride=2)
        self.k_conv2 = nn.Conv2d(in_channels, in_channels, kernel_size=5, stride=2)
